  ...
  <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:18px;flex-wrap:wrap;">
    <div>
      ...
      <div class="hint" style="margin-top:6px;">
        ...
        if ($statusFilter !== 'all') $activeFilters[] = ($statusFilter === 'live' ? 'Live' : 'Coming Soon');
    ...
    <form method="get" action="/HIRA/admin/products.php">
      <div class="form-grid" style="grid-template-columns: 1.6fr 1fr 1fr; align-items:end;">
        <div class="field">
          ...
          <input id="q" type="text" name="q" value="<?php echo e($searchQuery); ?>" placeholder="Product name or category">
        </div>
        <div class="field">
